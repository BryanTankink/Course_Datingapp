...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        public async Task<ActionResult<MessageDto>> CreateMessage([FromBody] CreateMessageDto createMessageDto) {
            ...
            if(recipient == null) return BadRequest("failed to find recipient");
        ...
        public async Task<ActionResult> DeleteMessage(int id) {
            ...
            if(message == null) return BadRequest("Invalid message id");
            if(message.SenderUsername != username && message.RecipientUsername != username) return Unauthorized("You have nothing to do with this message");
